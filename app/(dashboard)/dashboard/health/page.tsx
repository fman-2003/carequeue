...
export default function HealthProfilePage() {
  ...
  if (loading)
    return <p className="text-gray-500">Loading health profile...</p>;
  ...
  return (
    <div className="max-w-2xl">
      ...
      <p className="text-sm text-gray-500 mb-6">
        This information helps your doctor provide better care. Only your doctor
        and clinic can see this.
      </p>
          ...
          <div>
            ...
            <div className="flex gap-2 mb-2">
              ...
              <button
                type="button"
                onClick={() =>
                  addToArray("familyHistory", newFamily, () => setNewFamily(""))
                }
                className="px-3 py-2 bg-blue-600 text-white rounded text-sm hover:bg-blue-700 transition"
              >
                Add
