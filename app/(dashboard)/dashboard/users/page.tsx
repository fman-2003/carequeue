    ...
    <div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-lg w-full max-w-lg mx-4 max-h-[85vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
              ...
              <button
                onClick={() => { setSelected(null); setUserType(null); setDoctorStats(null) }}
              ...
              {userType === 'doctor' && (
                <div>
                  ...
                  {statsLoading ? (
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {[
                        { label: 'Total Appointments', value: doctorStats.total          },
                        ...
                        { label: 'Completion Rate',    value: `${doctorStats.completionRate}%` },
                        { label: 'No-Show Rate',       value: `${doctorStats.noShowRate}%`     },
                        { label: 'Waitlist Patients',  value: doctorStats.waitlistCount   },
                      ].map(({ label, value }) => (
                        <div key={label} className="bg-gray-50 rounded p-3">
                          <p className="text-xs text-gray-400">{label}</p>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-gray-50 rounded p-3">
                      <p className="text-xs text-gray-400">Preferred Doctor</p>
                      <p className="font-medium text-gray-800 mt-0.5">
                        {selected.preferredDoctorId
                          ? doctors.find((d) => d._id === selected.preferredDoctorId)?.name || 'Set'
                          : 'Not set'
                        }
                      </p>
                    </div>
      ...
      <section className="mb-8">
        ...
        {filteredDoctors.length === 0 ? (
          <p className="text-gray-400 text-sm">No doctors match your search.</p>
        ) : (
